...
<!--[if gt IE 8]><!--> <html class="no-js" lang=""> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="${ctx}/js/jquery/plugins/DataTables-1.10.2/media/css/jquery.dataTables.css">
        <script src="${ctx}/js/jquery/plugins/DataTables-1.10.2/media/js/jquery.dataTables.js"></script>
        		...
        		$('#configs').dataTable({
        	        ...
        	        "ajax":{
        	        	...
        	        	"dataSrc":function(json){
        	        			...
        	        			for(key in list){
        	        				var links = [
													" <a refId ='"+list[key].id+"' href='#' class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></a>",
													" <a refId ='"+list[key].id+"' href='#' class=\"glyphicon glyphicon-remove\" aria-hidden=\"true\"></a>"
        	        				            ];
    ...
    <div class="container">
      ...
      <div class="row">
      	<div class="col-md-3">
          <h2>泛信徒</h2>
          <p>主原谅你的自私、虚伪，因为在主是慈悲的</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-3">
          <h2>虔信徒</h2>
          <p>主感到了你的虔诚，因为你的主是你行为的最高准则</p>
          <p><a class="btn btn-default" href="#" role="button">View details &raquo;</a></p>
        </div>
        <div class="col-md-3">
          <h2>狂信徒</h2>
      ...
      <footer>
        <p>&copy; RaiseDragon.King 2015</p>
      </footer>
    </div> <!-- /container -->        
