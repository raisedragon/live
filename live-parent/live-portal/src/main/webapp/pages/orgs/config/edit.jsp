    ...
    <div class="jumbotron">
      <div class="container">
		  ...
		  <div class="form-group">
		    ...
		    <input type="email" class="form-control" id="name" placeholder="Cofiguration name">
		  </div>
		  <div class="form-group">
		    <label for="value">Password</label>
		    <input type="password" class="form-control" id="value" placeholder="Cofiguration value">
		  </div>
		  <div class="form-group">
