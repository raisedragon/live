...
import com.raise.orgs.impl.db.BulkDeleteable;
import com.raise.orgs.impl.db.HasRevision;
import com.raise.orgs.impl.db.PersistentObject;
import com.raise.orgs.impl.attr.ValueFields;
import com.raise.orgs.impl.attr.AttributeType;

public class AttributeInstanceEntity implements ValueFields, PersistentObject, HasRevision, BulkDeleteable, Serializable {
  ...
  protected AttributeInstanceEntity() {
  }
  
  public static void touch(AttributeInstanceEntity variableInstance) {
  ...
  public static AttributeInstanceEntity createAndInsert(String name, AttributeType type, Object value) {
    AttributeInstanceEntity variableInstance = create(name, type, value);
  ...
  public static AttributeInstanceEntity create(String name, AttributeType type, Object value) {
    AttributeInstanceEntity variableInstance = new AttributeInstanceEntity();
