...
/**
 * Interface describing a container for all available {@link AttributeType}s of variables.
 * @author dsyer
...
public interface VariableTypes {
  ...
  public VariableTypes addType(AttributeType type);
   ...
   * index will be used.
   */
  public VariableTypes addType(AttributeType type, int index);
