...
import com.raise.orgs.cfg.ProcessEngineConfigurator;
...
import com.raise.orgs.impl.ServiceImpl;
import com.raise.orgs.impl.cfg.standalone.StandaloneMybatisTransactionContextFactory;
import com.raise.orgs.impl.db.DbIdGenerator;
import com.raise.orgs.impl.db.DbSqlSessionFactory;
import com.raise.orgs.impl.db.IbatisVariableTypeHandler;
import com.raise.orgs.impl.delegate.DefaultDelegateInterceptor;
import com.raise.orgs.impl.interceptor.CommandConfig;
import com.raise.orgs.impl.interceptor.CommandContextFactory;
...
import com.raise.orgs.impl.interceptor.CommandInvoker;
import com.raise.orgs.impl.interceptor.DelegateInterceptor;
import com.raise.orgs.impl.interceptor.LogInterceptor;
import com.raise.orgs.impl.interceptor.SessionFactory;
import com.raise.orgs.impl.persistence.GenericManagerFactory;
import com.raise.orgs.impl.persistence.GroupEntityManagerFactory;
import com.raise.orgs.impl.persistence.MembershipEntityManagerFactory;
...
import com.raise.orgs.impl.util.ReflectUtil;
import com.raise.orgs.impl.variable.BooleanType;
import com.raise.orgs.impl.variable.ByteArrayType;
import com.raise.orgs.impl.variable.CustomObjectType;
import com.raise.orgs.impl.variable.DateType;
import com.raise.orgs.impl.variable.DefaultVariableTypes;
import com.raise.orgs.impl.variable.DoubleType;
import com.raise.orgs.impl.variable.EntityManagerSession;
import com.raise.orgs.impl.variable.EntityManagerSessionFactory;
import com.raise.orgs.impl.variable.IntegerType;
import com.raise.orgs.impl.variable.JPAEntityVariableType;
import com.raise.orgs.impl.variable.LongStringType;
import com.raise.orgs.impl.variable.LongType;
import com.raise.orgs.impl.variable.NullType;
import com.raise.orgs.impl.variable.SerializableType;
import com.raise.orgs.impl.variable.ShortType;
import com.raise.orgs.impl.variable.StringType;
import com.raise.orgs.impl.variable.UUIDType;
