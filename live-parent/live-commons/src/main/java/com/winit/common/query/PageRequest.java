 ...
 * @author
 */
public class PageRequest extends AbstractPageRequest implements Pageable, Serializable{
	...
	/*
	 * (non-Javadoc)
	 * @see org.springframework.data.entity.Pageable#getSort()
	 */
	public Sort getSort() {
		return sort;
	}
	...
	/* 
	 * (non-Javadoc)
	 * @see org.springframework.data.entity.AbstractPageRequest#previous()
	 */
