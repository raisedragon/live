...
import com.winit.common.query.exception.SearchException;
import com.winit.common.query.filter.*;
import com.winit.common.query.utils.SearchableConvertUtils;
...
public final class SearchRequest extends Searchable  implements Serializable {
    ...
    /**
     * @param searchParams
     * @see SearchRequest#SearchRequest(java.util.Map<String,Object>)
     */
    ...
    @Override
    public SearchRequest addSearchFilters(Collection<? extends SearchFilter> searchFil3ters) {
        if (Collections3.isEmpty(searchFilters)) {
            return this;
        }
    ...
    @Override
    public SearchRequest or(final SearchFilter first, final SearchFilter... others) {
        addSearchFilter(SearchFilterHelper.or(first, others));
        return this;
    }

    @Override
    public SearchRequest and(final SearchFilter first, final SearchFilter... others) {
