package com.raise.core.identity.impl;
...
/**
 * @author RaiseDragon
 * ÿһ�� ID ���� 64 λ���֣���ʱ������ڵ�ź����б����ɡ�
 * ���б���� 12 λ����ζ��ÿ���ڵ���ÿ������Բ��� 4096 �� ID��
 * �ڵ����Դ���б��ֳ������֣�������ĵ� ID �ͽڵ� ID������ռ 5 λ��
 * ʱ������Ǽ�¼�˴� 1288834974657 (Thu, 04 Nov 2010 01:42:54 GMT) ��һʱ�̵���ǰʱ�����ĺ�����ռ 41 λ������һλ�Ƿ��λ����ԶΪ 0����
 *
 */
